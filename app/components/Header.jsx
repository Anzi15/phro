...
export default function Header({children}) {
  ...
  return (
    ...
    <Image
        ...
        priority={true}
        draggable={false}
        className="select-none min-w-[10rem]"
        />
        </Link>
      <Navbar links={links} />
      ...
      <Link className="p-3 px-4 rounded-full bg-blue-700 text-white font-bold hover:bg-blue-900 transition-all flex-nowrap text-nowrap hidden md:block" href="/donate">Donate now</Link>
      <MobileNavbar
        links={links}
