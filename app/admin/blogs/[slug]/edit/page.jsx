...
import Preview from "../../../../components/BlogPagePreview";
...
const AdminBlogEditPage = ({params}) => {
  ...
  initialCoverImage === coverImage.preview 
    ? { originalUrl: coverImage.preview, thumbnails: initialCoverImageThumbnails } 
        ...
        <section className="md:flex ">
          ...
          >
            ...
            <div className="flex flex-col gap-4 ">
              <ImageDropZone storeFileToUpload={setCoverImage} displayImg={coverImage?.preview} />
          ...
          <div className="md:w-1/2 w-full flex flex-col px-5">
            ...
            <Preview
              blogData={{
                ...
                coverImage: coverImage ? coverImage : {preview: placeholderImg},
                content: content
              }}
            />
          </div>
