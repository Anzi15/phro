...
const paypalClientId = process.env.NEXT_PUBLIC_PAYPAL_PUBLIC_ID || ""
// const paypalClientId = loadStripe(process.env.NEXT_PUBLIC_PAYPAL_PUBLIC_ID || "")
...
<PayPalScriptProvider options={{ "client-id": paypalClientId, currency: "USD" }}>
    ...
    <PayPalButtons
      fundingSource={undefined}  // or 'paypal' / 'card' / 'paylater' to restrict
      ...
      funding={{
        allowed: ['paypal', 'paylater', 'card']  // specify which funding sources you want
      }}
    />
